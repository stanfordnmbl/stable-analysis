...
def get_features_sls_rtt_ec():
    print('Running sls_rtt_ec...')
    record_ids = ['42', '68', '140', '144']
    for i in range(4):
            record_id = record_ids[i]
            sls_rtt_ec_features = {}  
            trial_names = ["sls-rtt-ec"]
            ...
            sls_rtt_ec_features = {"time_r": time_r, "time_l": time_l, "mean_com_speed_r": mean_com_speed_r, "mean_com_speed_l": mean_com_speed_l, "c7_std_r": c7_std_r, "c7_std_l": c7_std_l, "peak_pf_r": peak_pf_r, "peak_pf_l": peak_pf_l}

            filepath = 'features/sls_rtt_ec_features_' + record_id + '.json'
            with open(filepath, 'w') as json_file:
              json.dump(sls_rtt_ec_features, json_file)
    print('Finished')